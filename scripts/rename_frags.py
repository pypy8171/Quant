...
WHOLE = {
    ...
    'lav': 'ledger_average', 'pit': 'position_iterator', 'pr': 'daily_lookup', 'sit': 'strategy_iterator',
...
PER_FILE = {
    ...
    'feed_latency_measure.cpp': {'sp': 'session', 'want': 'wanted_count'},
    ...
    'main.cpp': {'sp': 'startup_check_node'},
