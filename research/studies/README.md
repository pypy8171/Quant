...
| [13_trendx_gate/](13_trendx_gate/README.md) | TRENDX 게이트(정배열 ∧ 이격 5~35) 하락장 일봉 근사 · 점수 순위상관(IC) · 3분봉 리플레이 | 선정 층만 잰다. 현행 셀은 4구간 합산 월 초과R −0.062(t=−3.55), 홀드아웃 2022 −0.115로 PIT 풀 기저에 뒤지고 탐색 11셀에 양인 셀 없음. 점수 IC는 양(+)이지만 상위 25가 2022·2024에서 기저를 못 넘음. 리플레이는 라이브 4일 대조에서 건수가 크게 달라 결론 미승격. **bias-auditor 감사 전 수치.** |
