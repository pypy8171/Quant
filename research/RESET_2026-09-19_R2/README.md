...
- (2026-09-20) 스터디 22로 (1)(2)(3)을 실행 — 세 층 통과, 채택 후보. 숫자는 §8 3행과 `research/studies/22_pbr_roe_value_tilt/README.md`. 등급은 재무가 B라 B 유지.
- (2026-09-20) 스터디 23 `research/studies/23_value_tilt_liquidity_floor/`로 22의 남은 의문 셋(용량 32억·창 기준 3/5·판정 구간)을 한 번에 확인 — 거래대금 하한 30억·50억, 7창(2019~2025), 층 ② 6/7로 다시 재도 두 유니버스 모두 세 층 통과(30억 +13.48% t 2.82 용량 96억, 50억 +10.76% t 2.20 용량 158억). 남은 것은 모의 소액 forward(§7). 합격 숫자의 뜻·출처는 `research/studies/READING_NUMBERS.md`.
...
| 3 | S5(저변동 바스켓) 4슬롯 | `strategist.md` §3 | 스터디 18(H10) 2026-09-20 완료 — 미달(초과수익 t 0.72·창 4/7, MDD는 유니버스의 3분의 2). 롱 슬롯 배정 안 함 |
...
| 3 | 스터디 19 후속(새 번호) | §3-1 다음 실행 조건 | (1단계 끝, 2026-09-20) 상폐사 포함 회사 목록: `PYQuant/tools/kind_delisted_fill.py`가 KIND 상장폐지 2000~2026 1,475건에 종목코드 99%를 붙이고 패널에 없던 상폐사 599종목 일봉을 네이버에서 받아 `bars_all_pit_v2` 3,081→3,680종목(상폐 340→939). 2008년 이후 상폐 커버 90~100%(2019~2021 100/92/100), 2007년 이전은 네이버에 자료가 없어 0~25%. 회원 기간표 `PYQuant/data/universe/membership.parquet`(effective_from/to·end_reason·terminal_price 결측 0). 2단계 끝: 스터디 22 `research/studies/22_pbr_roe_value_tilt/`(중심 N=30·w=0.7·분기 리밸 사전등록, 격자 27칸) — 판정 구간 순초과수익 연 +15.70%(t 2.41), walk-forward 4/5, 이웃 6/6 → 세 층 통과 **채택 후보**. 시총가중 +10.02%(비 0.64), 크기 3분위 고름(+15.6/+15.7/+13.0), 용량 10% 한도 32억(거래대금 하한 10억 종목이 정함). 판정 구간이 19에서 본 구간이라 forward 검증으로 넘긴다. (3단계 끝, 2026-09-20) 스터디 23 — 하한 30억·50억, 7창, 6/7로 다시 재도 둘 다 세 층 통과(30억 +13.48%·t 2.82·6/7·용량 96억, 50억 +10.76%·t 2.20·6/7·용량 158억). 22는 거래 얇은 종목 의존이 아니다. 남은 것은 모의 소액 forward |
