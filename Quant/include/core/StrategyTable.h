...
//  나머지 전략이 전부 번호를 못 받는다. 1024였을 때 2,700종목 부하시험이 1,021번째 전략에서 멎었다
//  (2026-09-25 실측: 갈라 띄운 판은 번호를 기다리다 교착, 한 프로세스 판은 그 종목의 주문 52,916건을
//  말이 안 되는 요청으로 버렸다). 이름 한 칸이 32바이트라 표 전체가 256KB다.
//  숫자를 바꿀 때는 kDefaultSymbolCapacity 와 같이 바꾼다.
