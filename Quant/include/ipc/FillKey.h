...
//  확인) 이 조합이 키다 [why D-121] — 체결시각이 초 단위라 같은 초·같은 수량·같은 단가는 구분하지 못한다.
//  라우터의 fill_sightings_·unlinked_fill_keys_가 쓰고, bench_order_path_keys가 옛 문자열 키와 견준다. [why D-112]
#include <cstddef>
#include <cstdint>
