...
int main()
{
    ...
    // 6. regime_strategies — RISK_ON/RISK_OFF와 BULL/BEAR를 같은 국면으로 받고, 모르는 키는 버린다.
    {
        ...
        document["startup_probe"]     = {{"ticker", "005930"}, {"qty", 1}};
        ...
        CHECK(app.has_startup_probe && app.startup_probe_ticker == "005930" && app.startup_probe_quantity == 1);
